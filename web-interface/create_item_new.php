					...
					if($("#ans_type").val() == ""){
						...
						if(anstype == 0){
							...
							for(var i=0;i<nchoice;i++){
								choices_content += "<label>Choice "+String.fromCharCode(alpha++)+": </label>"
								//+"&nbsp;<button id='tbutton-"+(i+1)+"' type='button'>test-"+(i+1)+"</button>"
								+"&nbsp;<span id='count-ans-"+(i+1)+"' style='color:green;'>Character count: 0</span>"
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							Create Item <small>Item Bank</small>
						</h1>
						<ol class="breadcrumb">
							...
							<div class="panel-body">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="well">
														...
														<div>
															<label for="n_choice">Number of choices</label>
											...
											<div class="row">
												...
												<div class="col-md-9">
													<form accept-charset="UTF-8">
														<div class="row">
															<div class="col-md-8">
																<label>Discrimination Power (d)</label>
																<div>
														...
														<div class="row">
															<div class="col-md-6">
																<label>Difficulty Level (p)</label>
																<div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										&nbsp;&nbsp;&nbsp;
										<button class="btn btn-default" name="reset" value="reset">Reset</button>
									</div>
